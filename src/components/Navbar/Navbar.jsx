      ...
      >
         <div className="flex items-center justify-between p-4 pb-0 font-medium">
            ...
            <div className=" hidden md:flex md:justify-between md:w-3/4">
               ...
               <div className="text-white hidden md:block hover:text-[#3A7DE8]"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
